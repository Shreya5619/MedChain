...
const IntNav = () => {
  ...
  const navLinks = [
    { name: "Add Transaction", path: "/intermediary", icon: <Plus size={18} /> },
    { name: "Track", path: "/intermediary/track", icon: <Activity size={18} /> },
    { name: "View All", path: "/intermediary/view", icon: <List size={18} /> },
  ];
    ...
    >
      <nav className="mx-auto max-w-5xl bg-med-teal/95 backdrop-blur-md rounded-full shadow-lg px-6 py-3 flex justify-between items-center text-white">
        ...
        <Link to="/" className="text-xl font-serif font-bold tracking-tight hover:text-med-teal-light transition-colors">
          MedChain <span className="text-med-teal-light font-sans text-xs font-normal ml-1">INTERMEDIARY</span>
        </Link>
