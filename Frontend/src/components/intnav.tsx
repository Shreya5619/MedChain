      ...
      <nav className="bg-gray-800 p-4 shadow-lg w-[70%] h-15 rounded-full text-white font-bold">
        <div className="flex items-center justify-between">
          ...
          <ul className="hidden md:flex space-x-8 text-white">
            ...
            <li>
              <a href="/intermediary" className="hover:text-blue-400">
                Add
              </a>
            </li>
            <li>
              <a href="/intermediary/track" className="hover:text-blue-400">
                Track
              </a>
            </li>
            <li>
              <Link to="/intermediary/view" className="hover:text-blue-400">
                View
              </Link>
            </li>
            <li>
